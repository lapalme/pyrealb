...
dependentsSect ={"fr":"Dépendents","en":"Dependencies",
     "ex":[
         ...
         {"pattern":"coord(C(…)…)","fr":["Coordination",'coord(C("et"),subj(N("chat")),subj(N("chien")),'
                                                    'subj(N("souris"))).n("p")'],
                        "en":["Coordination",'coord(C("and"),subj(N("cat")),subj(N("dog")),subj(N("mouse"))).n("p")']},
         {"pattern":'coord(Q("")…)',"fr":["Coordination sans <code>C</code>",'coord(Q(""),subj(N("chat")),'
                                                                          'subj(N("chien")),'
                                                    'subj(N("souris"))).n("p")'],
                        "en":["Coordination without <code>C</code>",'coord(Q(""),subj(N("cat")),subj(N("dog")),'
                                                              'subj(N("mouse"))).n("p")']},
     ]}
...
optionsSect= {"fr":"","en":"",
     "ex":[
           ...
           {"group":".t(…)","fr":'Temps composés (défaut "p")',
                            "en":'Compound tenses (see <code>.typ({"perf":True})</code>)'},
...
pronomsSect={"fr":"","en":"",
    "ex":[{"group":"","fr":'Pronom sujet',"en":'Pronoun as subject'},
          ...
          {"pattern":".pe(3)", "fr":["3e personne du masculin singulier",'Pro("moi").pe(3)'],
...
sentType={"fr":'',"en":'',
    "ex": [
       ...
       {"pattern": '.typ({"int":"tag"})',
        "fr": ["N'est-ce pas (demande confirmation)",
               'S(NP(D("le"),N("chat")),\n  VP(V("aimer"),NP(D("le"),N("souris")))).typ({"int":"tag"})'],
        "en": ["Question tag (confirmation?)",
...
dateOption={"fr":"Formatage d'une date (défaut <code>.nat()</code>)",
    ...
    "ex":[
        ...
        {"pattern":'{"rtime":".." or Date}',"fr":["Date relative avant une autre date",'DT("2021-09-01").dOpt({"rtime":datetime.datetime(2021,9,10),"hour":False,"minute":False,"second":False})'],
                            "en":["Relative date before another one",'DT("2021-09-01").dOpt({"rtime":datetime.datetime(2021,9,10),"hour":False,"minute":False,"second":False})']},
        ]}
