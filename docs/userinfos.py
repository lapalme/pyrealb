...
dateOption={"fr":"Formatage d'une date (défaut <code>.nat()</code>)",
    ...
    "ex":[
        ...
        {"group":'.dOpt({"year": , "month": , "date": , "day": ,\n "hour": , "minute": , "second": , "nat":, "det":, "rtime":})',
        ...
        {"pattern":'{"det":False}',"fr":["Non affichage du déterminant de la date",'DT().dOpt({"det": False})'],
        ...
        {"pattern":'{"rtime":".." or Date}',
         "fr":["Date relative avant une autre date",'DT("2021-09-01").dOpt({"rtime":datetime.datetime(2021,9,10),\n"hour":False,"minute":False,"second":False})'],
