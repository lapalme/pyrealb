...
def sentences_fr():
    ...
    return [
        ...
        #   41 version en constituant de Bonfante et al. Exercice 2.51 p 72
        ...
        #   42 version simplifiée en constituant de Bonfante et al. Exercice 2.51 p 72
        {"expression":S(S(VP(V("trouver").t("b"),
                             NP(D("un"),N("livre"),
                                SP(Pro("que"),
                                   Pro("lui").c("nom"),
        ...
        #   44 - version en constituants de Bonfante et al. Exemple 3.1 p 82
          {"expression":
               S(Pro("lui").c("nom"),
                 VP(V("indiquer").t("c"),
                    SP(C("si"),
        ...
        # 83
        {"expression":S( NP( N("pierre").n("p"), SP( Pro("qui"), VP( V("rouler")))), VP( V("amasser"),
                                                                                         NP( N("mousse")))).typ({"neg":True}),
