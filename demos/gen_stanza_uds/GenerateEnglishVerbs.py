...
2	{verb_form}	{verb_lemma}	VERB	VBP	{verb_feats}	0	root	_	_
...
3	{pr_form}	{pr_lemma}	VERB	VBG	{pr_feats}	0	root	_	_
...
if __name__ == "__main__":
    ...
    verbFile = open("allverbs.txt", "w", encoding="utf-8")
    regularVerbsUD = open("allverbs.conllu","w",encoding="utf-8")
    for verb_lemma in verbs:
        regularVerbsUD.write("\n".join(makeVerb(verb_lemma))+"\n")
    print(len(verbs), "verbs conjugated")
