...
class Entity:
    ...
    def has_entity_role(self, other_entity: str, other_role: str = None):
        return self.entity == other_entity and self.role == other_role
...
class Entities:
    def __init__(self, data: list[Union[Entity, dict[str, Union[int, str]]]]) -> None:
