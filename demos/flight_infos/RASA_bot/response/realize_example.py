...
if sys.path[1].endswith("RASA_bot"):  # HACK to determine if this file is imported from actions.py
    # stange imports for RASA for files in the actions directory
    # using the "workaround" found
    # at https://forum.rasa.com/t/import-custom-module-in-actions-py/44793
    from . import Entities_module
else:
    import Entities_module

flight_fields = Entities_module.flight_fields
