...
[Guy Lapalme](mailto:lapalme@iro.umontreal.ca), Université de Montréal, August 2023
...
Although the data is available as a [Hugging Face dataset](https://huggingface.co/docs/datasets/index), currently we do not use any of the interesting properties for accessing efficiently columnar data, we load the whole dataset once and process it like an array (`list` in Python) of JSON structures. The numeric values are converted to `int`s and corrected when it is first loaded.
...
> The Heat  (2-0) , leader in their conference, defeated the 76ers  (0-3) 114-96 on Saturday
> in Philadelphia at the Wells Fargo Center.
>
> The Heat led in all four quarters.
>
> Chris Bosh who was a starter scored a game high with 30 points with four assists. Tony
> Wroten who started this game scored a game high with 21 points with ten assists and
> performed a double-double.
>
> The Heat showed 49 percent from the field and 20-29 free throws.  Mario Chalmers who was a
> starter recorded 20 points with six goals.  Luol Deng recorded 15 points.  Shawne Williams
> recorded 15 points  (5-9 FG, 3-5 3Pt, 2-2 FT) while adding four assists.  Dwyane Wade
> scored nine points  (4-18 FG, 0-1 3Pt, 1-3 FT) and ten assists.
>
> The 76ers showed 52 percent from the field and 19-26 free throws and committed 24
> turnovers.  Brandon Davies who was a starter finished with 18 points with 7-for-9 FG.  Luc
> Mbah a Moute added nine points  (4-10 FG, 0-2 3Pt, 1-2 FT) and three assists.  Malcolm
> Thomas contributed an efficient eight points in 19 minutes with nine rebounds.  Alexey
> Shved added six points  (1-4 FG, 1-4 3Pt, 3-3 FT) while adding six assists.
>
...
> Les Heat  (2-0) , meneurs dans leur conférence, ont dominé les 76ers  (0-3) 114-96 au
> stade Wells Fargo Center samedi à Philadelphia.
>
> Les Heat ont mené dans les quatre quarts.
>
> Chris Bosh qui figurait dans l'alignement de départ a mené son équipe marquant 30 points
> (9-17 L, 2-5 L3, 10-11 LF) tout en ajoutant quatre passes décisives. Tony Wroten qui était
> un partant a fini avec 21 points  (6-11 L, 1-4 L3, 8-11 LF) tout en ajoutant dix passes
> décisives et a terminé avec un double-double.
>
> Les Heat ont compté 49 pour cent de tirs réussis et 20 lancers francs sur 29.  Mario
> Chalmers qui débutait la partie a eu 20 points avec six tirs réussis.  Luol Deng a marqué
> 15 points.  Shawne Williams a terminé avec 15 points  (5-9 L, 3-5 L3, 2-2 LF) et quatre
> passes décisives.  Dwyane Wade a terminé avec neuf points avec dix passes décisives.
>
> Les 76ers ont compté 52 pour cent de tirs réussis et 19 lancers francs sur 26 et ont subi
> 24 pertes de ballon.  Brandon Davies qui figurait dans l'alignement de départ a enregistré
> 18 points.  Luc Mbah a Moute a eu neuf points avec sept rebonds et trois passes décisives.
> Malcolm Thomas a enregistré huit points en 19 minutes.  Alexey Shved a fini avec six
> points  (1-4 L, 1-4 L3, 3-3 LF) tout en ajoutant six passes décisives.
>
> Le prochain match des Heat sera à domicile contre les Raptors de Toronto dimanche. Pour
> leur prochaine partie, les 76ers accueilleront les Rockets de Houston lundi.
...
```
1. Give the winner and loser scores with location and date information about the game and mention winning streak if it long enough
...
We thus see that these methods all return strings to be called by the following `summarize` function with two parameters: the first, `realizer` is an instance of a subclass of `BasketSummarizer`  implementing these five methods; the second parameter `game` gives access to the data about this game . 
